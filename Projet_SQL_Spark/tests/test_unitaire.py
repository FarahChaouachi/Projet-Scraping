...
from tests.schemadatatest import (
    schema_data,
...
# Test for writing to a CSV file
...
# Test for get_initial_transformation
def test_get_initial_transformation(spark):
    # Input data with date correction
    data = [
...
# Test for get_intermediate_transformation
